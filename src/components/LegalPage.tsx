...
const TERMS_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    body: "By placing an order through the App, you agree to pay the listed price plus any applicable delivery fees and taxes. Prices are set by individual chefs and may change without notice. Tinmen processes payments on behalf of chefs and delivery partners. Refunds are subject to our refund policy.",
  },
  {
...
const PRIVACY_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    body: "We collect information you provide directly, including: (a) phone number and name during registration; (b) profile information; (c) delivery addresses and saved locations; (d) chat messages with chefs and delivery partners; (e) order history and payment information. We also automatically collect device information, usage data, and location data when you use the App.",
  },
  {
    title: "3. How We Use Your Information",
    body: "We use your information to: (a) create and manage your account; (b) process and fulfill your food orders; (c) facilitate communication between you, chefs, and delivery partners; (d) process payments; (e) improve our services and develop new features; (f) send you service-related notifications; (g) ensure safety and security of the platform; (h) comply with legal obligations.",
  },
  {
  ...
  },
  {
    ...
    body: "We retain your personal information for as long as your account is active or as needed to provide services. After account deletion, we retain certain data for up to 30 days for processing, after which it is permanently deleted. Some data may be retained longer if required by law or for legitimate business purposes.",
  },
  {
  ...
  },
  {
    ...
    body: "The App may use third-party services including Back4App (data storage), Mapbox (mapping and geocoding), and Expo (app delivery). These services have their own privacy policies, and we encourage you to review them. We are not responsible for the privacy practices of third-party services.",
  },
  {
